...
<body>
<%pageContext.setAttribute("navinfo", "- 广告审核");%>
<%-- 公共的顶部导航栏 --%>
...
<script type="text/javascript">
    // 点击某个侧边栏  让其处于展开状态
    $("a[href='audi/auth_adv.html']").css("color", "red");
    $("a[href='audi/auth_adv.html']").parents(".list-group-item").removeClass("tree-closed");
    $("a[href='audi/auth_adv.html']").parent().parent("ul").show(100);
</script>
</html>
